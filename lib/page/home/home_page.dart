  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: AppTheme.colors.appBar, //Cor de fundo da Appbar
        foregroundColor: AppTheme.colors.appBarTitle, //Cor do texto da Appbar
      ),
                    ...
                    Stack(
                      ...
                      children: [
                        Column(
                          children: [
                            Text(
                              "Olá, seja bem-vindo ao Lord's Garden!",
                              style: TextStyle(
                                fontSize: 18,
