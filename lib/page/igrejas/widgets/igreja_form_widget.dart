...
class IgrejaFormWidget extends StatefulWidget {
  const IgrejaFormWidget({super.key});

  @override
  _IgrejaFormWidgetState createState() => _IgrejaFormWidgetState();
}

class _IgrejaFormWidgetState extends State<IgrejaFormWidget> {
  ...
  Future<void> _salvarDados() async {
    try {
      ...
      if (user != null) {
        ...
        await _firestore.collection('igrejas').add(data);

        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content: const Text('Cadastro da igreja concluído com sucesso',
